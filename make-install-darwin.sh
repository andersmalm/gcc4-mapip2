...
export mosyncSource=~/Work/gcc4fp/MoSync
...
cp -v xgcc $MOSYNCDIR/mapip2/ && \
mkdir -p $MOSYNCDIR/libexec/gcc/mapip2/4.6.3/ && \
cp -v cpp $MOSYNCDIR/libexec/gcc/mapip2/4.6.3/ && \
cp -v cc1 $MOSYNCDIR/libexec/gcc/mapip2/4.6.3/ && \
cp -v cc1plus $MOSYNCDIR/libexec/gcc/mapip2/4.6.3/ && \
cd $mosyncSource && ./workfile.rb base && \
cd ~/Work/gcc4fp/binutils-mapip2 && ./workfile.rb && \
